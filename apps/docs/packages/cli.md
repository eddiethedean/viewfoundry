...
`viewfoundry init` is not implemented in v0.2.x. The CLI uses an empty import map on export; provide import maps in application code for production-ready TSX.
